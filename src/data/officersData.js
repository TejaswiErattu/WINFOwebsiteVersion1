...
export const officersData = {
  ...
  /* Co-Presidents (displayed larger, 2-column centered) */
  coPresidents: [
    {
      name: 'chloe mau',
      ...
      hometown: '',
      focusArea: 'informatics & international studies',
      funFact: '',
    },
    {
      name: 'stephanie lee',
      ...
      hometown: '',
      focusArea: 'informatics | product management',
      funFact: '',
    },
  ],
  ...
  directors: [
    ...
    },
    {
      ...
      year: 'junior (class of 2027)',
      hometown: '',
      focusArea: 'informatics | data science & cybersecurity',
      funFact: '',
    },
    {
      name: 'tiffany guan',
